class CartModel {
  ...
  CartModel.fromJson(Map<String, dynamic> json) {
    ...
    cartSellerid = json['items_seller'].toString();
    cartSellersDistance = json['distance'].toString();
    ...
    delName = json['delivery_name'].toString();
    delPhone = json['delivery_phone'].toString();
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['items_seller'] = this.cartSellerid;
    data['distance'] = this.cartSellersDistance;
