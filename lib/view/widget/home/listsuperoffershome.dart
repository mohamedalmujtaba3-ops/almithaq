...
class ListSuperOffersHome extends GetView<HomeControllerImp> {
  const ListSuperOffersHome({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: ListView.builder(
          itemCount: controller.supermarketsoffers.length,
          scrollDirection: Axis.horizontal,
          itemBuilder: (context, i) {
            return OffersHome(
                itemsModel: ItemsModel.fromJson(controller.supermarketsoffers[i]));
          }),
    );
  }
}
