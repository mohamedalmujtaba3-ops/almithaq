...
import 'package:almithaq/view/widget/cardlistrestaurants.dart';
...
class Restaurants extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    RestaurantsController thecontroller = Get.find();
    String city = thecontroller.myServices.sharedPreferences.getString("city")!;
    return Scaffold(
        appBar: AppBar(
          title: Text("المطاعم", style: TextStyle(fontSize: 14, color: Colors.white),),
          centerTitle: false,
          titleSpacing: 0,
                  ...
                  widget: ListView.builder(
                    ...
                    itemBuilder: ((context, index) {
                      if (index < controller.data.length) {
                        return CardRestaurantsList(search, city, listdata: controller.data[index]);
                      }
