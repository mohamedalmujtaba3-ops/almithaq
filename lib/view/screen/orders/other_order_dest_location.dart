...
class OtherOrderDestLocation extends StatefulWidget {
  const OtherOrderDestLocation({super.key});

  @override
  State<OtherOrderDestLocation> createState() => _DestinationModernLocationPickerState();
}

class _DestinationModernLocationPickerState extends State<OtherOrderDestLocation> {

  GoogleMapController? _mapController;
  LatLng? _currentPosition;
  LatLng? _selectedLocation;
  bool _isLoading = true;
  double start_lat = Get.arguments['lat'];
  double start_long = Get.arguments['long'];
  Set<Marker> _markers = {};
                    ...
                    children: [
                      ...
                      CustomButtomAuth( text: "تم التحديد",
                        onPressed: () {
                            ...
                            Get.toNamed(AppRoute.otherorderform, arguments: {
                              'start_lat' : start_lat,
