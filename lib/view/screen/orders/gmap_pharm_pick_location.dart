...
import 'package:almithaq/view/widget/customoptionsdialog.dart';
...
class GmapPharmPickLocation extends StatefulWidget {
  const GmapPharmPickLocation({super.key});

  @override
  State<GmapPharmPickLocation> createState() => _PharmModernLocationPickerState();
}

class _PharmModernLocationPickerState extends State<GmapPharmPickLocation> {
                      ...
                      CustomButtomAuth( text: "تم التحديد",
                        onPressed: () {
                            ...
                            content: CustomTextarea(
                              isNumber: false,
                              valid: (val) {
                                return validInput(val!, 20, 60, "text");
                              },
                              mycontroller: null,
                              hinttext: "وصف العنوان باختصار ووضوح",
                            ...
                            onConfirm: () {
                              ...
                              Get.dialog(CustomOptionsDialog(
                                    title: "الأدوية",
                                    middletxt:
                                        "كيف ترغب بإدخال الأدوية أو المنتجات التي ستطلبها ؟",
                                    onpressed1: () {
                                      Get.toNamed(AppRoute.pharmsform, 
                                        arguments: {
                                          "lat": lat,
                                          "long": long,
                                          "address": address
                                    ...
                                    btn1text: "كتابةً",
                                    onpressed2: () {
                                      Get.toNamed(AppRoute.pharmsformrousheta, 
                                      arguments: {
                                        "lat": lat,
                                        "long": long,
                                        "address": address
